...
const Home = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    getFollwedStories()
    initializeLocation()
    fetchAdvertisements() // NEW: Fetch ads on mount
  }, [])
  ...
  // NEW: Merge posts and ads whenever either changes
  useEffect(() => {
    ...
    const merged = mergeFeedWithAds(filteredPosts, advertisements);
    setMergedFeedData(merged);
  }, [allPosts, advertisements, selectedTab]);
  ...
  const onRefresh = async () => {
    ...
    await getCurrentStories()
    await getFollwedStories()
    await fetchAdvertisements() // NEW: Refresh ads too
    setLoading(false)
  }
              ...
              <View style={styles.header}>
                <View style={styles.userInfo}>
                  ...
                  <TouchableOpacity
                    ...
                    <Text style={styles.caption}>
                      <Text style={styles.caption}>
                        {selectedTab=='News'?'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.': post?.caption}
                      </Text>
                    </Text>
                  </TouchableOpacity>
                </View>
