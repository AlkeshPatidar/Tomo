...
import { Back, BottomIndicator, EmailIcon, EyeIcon, LockIcon, LoginBtn, SignUpbtn } from "../../assets/SVGs";
            ...
            <ScrollView contentContainerStyle={{
                ...
                <View style={{ marginTop: 15, alignItems: 'center' }}>
                    ...
                    <CustomText style={{
                        fontSize: 16,
                        fontFamily: FONTS_FAMILY.SourceSans3_Regular
                    }}>Already have an account? <CustomText style={{
                        fontSize: 16,
                        fontFamily: FONTS_FAMILY.SourceSans3_Medium,
                        color: 'green'
                    }}>Sign In</CustomText></CustomText>
                </View>
